...
#include "IronKnight/ItemStorage.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	IRONKNIGHT_API UClass* Z_Construct_UClass_AItemStorage();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AItemStorage_Statics::NewProp_WeaponMap_ValueProp = { "WeaponMap", nullptr, (EPropertyFlags)0x0004000000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_AWearpon_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItemStorage_Statics::NewProp_WeaponMap_MetaData[] = {
		{ "Category", "SaveData" },
		{ "Comment", "//We declare TMap hastable to save weapons and items\n" },
		{ "ModuleRelativePath", "ItemStorage.h" },
		{ "ToolTip", "We declare TMap hastable to save weapons and items" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItemStorage, 365301442);
	template<> IRONKNIGHT_API UClass* StaticClass<AItemStorage>()
	{
		return AItemStorage::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItemStorage(Z_Construct_UClass_AItemStorage, &AItemStorage::StaticClass, TEXT("/Script/IronKnight"), TEXT("AItemStorage"), false, nullptr, nullptr, nullptr);
