...
#include "IronKnight/MainAnimInstance.h"
...
// Cross Module References
	IRONKNIGHT_API UClass* Z_Construct_UClass_UMainAnimInstance_NoRegister();
	IRONKNIGHT_API UClass* Z_Construct_UClass_UMainAnimInstance();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMainAnimInstance_UpdateAnimationProperties_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "//Function will update our animation every frame in derived animation blueprint class\n" },
		{ "ModuleRelativePath", "MainAnimInstance.h" },
		{ "ToolTip", "Function will update our animation every frame in derived animation blueprint class" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bIsInTheAir_MetaData[];
#endif
		static void NewProp_bIsInTheAir_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsInTheAir;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMainAnimInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMainAnimInstance_UpdateAnimationProperties, "UpdateAnimationProperties" }, // 2367326855
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir_MetaData[] = {
		{ "Category", "Movement" },
		{ "ModuleRelativePath", "MainAnimInstance.h" },
	};
#endif
	void Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir_SetBit(void* Obj)
	{
		((UMainAnimInstance*)Obj)->bIsInTheAir = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir = { "bIsInTheAir", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMainAnimInstance), &Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMainAnimInstance_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMainAnimInstance_Statics::NewProp_bIsInTheAir,
	...
	IMPLEMENT_CLASS(UMainAnimInstance, 1248636182);
	template<> IRONKNIGHT_API UClass* StaticClass<UMainAnimInstance>()
	{
		return UMainAnimInstance::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMainAnimInstance(Z_Construct_UClass_UMainAnimInstance, &UMainAnimInstance::StaticClass, TEXT("/Script/IronKnight"), TEXT("UMainAnimInstance"), false, nullptr, nullptr, nullptr);
