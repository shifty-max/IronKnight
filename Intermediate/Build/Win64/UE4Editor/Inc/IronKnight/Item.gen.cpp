...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_CollisionVolume_MetaData[] = {
		...
		{ "Comment", "//base collision shape\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "base collision shape" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItem, 979965349);
	template<> IRONKNIGHT_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItem(Z_Construct_UClass_AItem, &AItem::StaticClass, TEXT("/Script/IronKnight"), TEXT("AItem"), false, nullptr, nullptr, nullptr);
